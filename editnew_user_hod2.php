  ...
  if(isset($_POST['submit'])){  // Form has been submitted
    ...
    if(empty($errors)){
      ...
      if(preg_match("/^[_\.0-9a-zA-Z-]+@([0-9a-zA-Z][0-9a-zA-Z-]+\.)+[a-zA-Z]{2,6}$/i",$email)){
          ...
          $lecturers = mysql_query($query, $connection);
          confirm_query($lecturers);*/

          $user = get_record_by_username($table_user, $username);
          while ($hod = mysql_fetch_array($user)) {
            $regno = $hod['username'];
            
            $qry = "UPDATE users_hod SET pnum = '$pnum', email = '$email', answer1 = '$answer1', answer2 = '$answer2'  WHERE username = '$regno' ";
          ...
          <article class="col-md-5">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <form action="hods.php" method="post">
                     <table>
                       <tr>
          ...
          <article class="col-md-5">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <form action="editnew_user_hod1.php" method="post">
                     <table>
                       <tr>
