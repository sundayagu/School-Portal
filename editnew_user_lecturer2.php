    ...
    if(empty($errors)){
      ...
      if(preg_match("/^[_\.0-9a-zA-Z-]+@([0-9a-zA-Z][0-9a-zA-Z-]+\.)+[a-zA-Z]{2,6}$/i",$email)){
          ...
          while ($lecturer = mysql_fetch_array($lecturers)) {
            $regno = $lecturer['username'];
            
            $qry = "UPDATE users_lecturer SET pnum = '$pnum', email = '$email', answer1 = '$answer1', answer2 = '$answer2'  WHERE username = '$regno' ";
          ...
          <article class="col-md-5">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <form action="editnew_user_lecturer1.php" method="post">
                     <table>
                       <tr>
