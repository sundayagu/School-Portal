...
<?php
	...
	if(isset($_POST['submit'])){  // Form has been submitted
		...
		$fields_with_lengths = array('password' => 15, 'password1' => 15, 'pnum' => 11);
		...
		if(empty($errors)){
			...
			if(preg_match("/^[_\.0-9a-zA-Z-]+@([0-9a-zA-Z][0-9a-zA-Z-]+\.)+[a-zA-Z]{2,6}$/i",$email)){
				...
				if($password == $password1){
					...
					while ($senate = mysql_fetch_array($result)) {
						$regno = $senate['username'];
						
						$qry = "UPDATE users_senate SET hashed_password = '$hashed_password', pnum = '$pnum', email = '$email', answer1 = '$answer1', answer2 = '$answer2', flogin = 2 WHERE username = '$regno' ";
