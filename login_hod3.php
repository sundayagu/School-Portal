			...
			if(preg_match("/^[_\.0-9a-zA-Z-]+@([0-9a-zA-Z][0-9a-zA-Z-]+\.)+[a-zA-Z]{2,6}$/i",$email)){
				...
				if($password == $password1){
					...
					while ($user = mysql_fetch_array($result)) {
						...
						$qry = "UPDATE users_hod SET hashed_password = '$hashed_password', pnum = '$pnum', email = '$email', answer1 = '$answer1', answer2 = '$answer2', flogin = 2 WHERE username = '$regno' ";
