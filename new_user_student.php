...
<?php
	...
	if(isset($_POST['submit'])){  // Form has been submitted
		...
		if(empty($errors)){
			...
			$query = "INSERT INTO users_student (
						stu_name, stu_sex, username, flogin, password1, dept_code, adm_sess, sflag
					) VALUES (
						'{$name}','{$sex}', '{$username}', '1', '1234', '{$dept}', '{$session}', 'sf'
					)";
...
<article class="col-lg-7 col-lg-offset-1 col-sm-7 col-sm-offset-1">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="new_user_student.php">Create student user</a></li>
    </ol>
    <div class="panel panel-default">
        <div class="panel-heading">
           <center>
		      <h4 style="color:blue">Create New Student's User Account</h4>
		   </center>
        </div>
        <div class="panel-body">
           <?php if(!empty($message)) {echo "<p class=\"message\">" . $message . "</p>";} ?>
		  <?php if(!empty($errors)) {display_errors($errors);} ?>
          <form action="new_user_student.php" method="post">
        	  <table>
          		 <tr>
                    <td><b>Name: </b></td>
    ...
    <a href="new_user_student.php">Clear</a>
    <br/>
