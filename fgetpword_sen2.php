...
<?php
	...
	if(isset($_POST['submit'])){  // Form has been submitted
		...
		if(empty($errors)){ // i.e no errors. every info was captured.

			//Check database to see if username and the questions exist and match.
			$table_user = 'users_senate';
			$result_set = get_pword_answers_others($table_user, $username, $question1, $question2);
				...
				<article class="col-md-5">
				    ...
				    <div class="panel panel-default">
				        ...
				        <div class="panel-body">
				         ...
				         <form action="fgetpword_sen3.php?username=<?php echo htmlspecialchars(urlencode($username));?>" method="post">
				        	   <table>
				          		 <tr>
				          		 	<td>*&nbsp;</td>
				...
				<article class="col-md-5">
				    ...
				    <div class="panel panel-default">
				        ...
				        <?php if(!empty($message)) {echo "<p class=\"message\">" . $message . "</p>";} ?>
				          ...
				          <form action="fgetpword_sen2.php" method="post">
				        	   <table>
				          		 <tr>
				          		 	<td style="color:red">*&nbsp;</td>
			...
			?>
				...
				<article class="col-md-5">
			        ...
			        <div class="panel-body">
			          ...
			          <form action="fgetpword_sen.php" method="post">
			        	   <table>
			          		 <tr>
	...
	}else{ // of Form has not been submited
		?>
				<?php include("includes/header.php"); ?>
				<br/><br/><br/><br/>
				<div class="col-md-4">
