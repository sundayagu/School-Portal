	...
	*/
	...
	if(isset($_POST['submit'])){  // Form has been submitted
		...
		if(empty($errors)){
	        ...
	        <?php echo "<form action=\"login_hod3.php?username=$username\" method=\"post\"> " ?>
	        	  <table>
	          		 <tr>
	                    <td><b>Name:</b> </td>
	                    <td><?php echo $name; ?></td>
		...
		<div class="col-md-3">
    		...
    		<?php
				...
				$query = "SELECT id, hod_name, hod_sex, username, hflag, adm_sess, dept_code, pnum, email, answer1, answer2 ";
				$query .= "FROM users_hod ";
				...
				if(mysql_num_rows($result_set) == 1){
					...
					$_SESSION['hod_name'] = $found_user['hod_name'];
					$_SESSION['hod_sex'] = $found_user['hod_sex'];
					$_SESSION['username'] = $found_user['username'];
					$_SESSION['hflag'] = $found_user['hflag'];
					...
					redirect_to("hods.php?regno=$regno");
			...
			?>
				...
				<article class="col-md-5">
			        ...
			        <div class="panel-body">
			          ...
			          <form action="login_hods.php" method="post">
			        	   <table>
			          		 <tr>
