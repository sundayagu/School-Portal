	...
	*/
	...
	if(isset($_POST['submit'])){  // Form has been submitted
		...
		if(empty($errors)){
	        ...
	        <?php echo "<form action=\"login_students3.php?username=$username\" method=\"post\"> " ?>
	        	  <table>
	          		 <tr>
	                    <td><b>Name:</b> </td>
	                    <td><?php echo $name; ?></td>
		...
		<div class="col-md-3">
    		...
    		<?php
				...
				$query = "SELECT id, stu_name, stu_sex, username, sflag, adm_sess, dept_code, pnum, email, answer1, answer2 ";
				...
				if(mysql_num_rows($result_set) == 1){
					...
					$_SESSION['stu_name'] = $found_user['stu_name'];
					$_SESSION['stu_sex'] = $found_user['stu_sex'];
					$_SESSION['username'] = $found_user['username'];
					$_SESSION['sflag'] = $found_user['sflag'];
					...
					redirect_to("students.php?regno=$regno");
					...
					<article class="col-md-5">
				        ...
				        <div class="panel-body">
				           <?php if(!empty($message)) {echo "<p class=\"message\">" . $message . "</p>";} ?>
						  <?php if(!empty($errors)) {display_errors($errors);} ?>
				          <form action="login_students2.php" method="post">
				        	   <table>
				          		 <tr>
				                    <td>Username: </td>
