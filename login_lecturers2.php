...
<?php
	...
	*/
	...
	if(isset($_POST['submit'])){  // Form has been submitted
		...
		$fields_with_lengths = array('username' => 11, 'password' => 30);
		...
		if(empty($errors)){
	        ...
	        <div class="panel-heading">
	        	<center>
		           ...
		           <h4 style="color:blue">Change your Password and complete your data</h4>
		        </center>
	        </div>
	        <div class="panel-body">
	        <!--   <?php if(!empty($message)) {echo "<p class=\"message\">" . $message . "</p>";} ?>
			  <?php if(!empty($errors)) {display_errors($errors);} ?>  -->
	        <?php echo "<form action=\"login_lecturers3.php?username=$username\" method=\"post\"> " ?>
	        	  <table>
	          		 <tr>
	                    <td><b>Name:</b> </td>
	                    <td><?php echo $name; ?></td>
	                 ...
	                 <!--<tr>
	                    <td><b>Status:</b> </td>
	                    <td><br /><?php echo trim($statdisplay['flag_name']); ?></td>
	                 </tr>-->
	                 ...
	                 <tr>
	                    ...
	                    <td><br /><input type="password" name="password1" maxlength="30" value="<?php echo htmlentities($password1); ?>" /></td>
	                 </tr>
	                 <tr>
		...
		<div class="col-md-3">
    		...
    		<?php
				...
				$query = "SELECT id, lec_name, lec_sex, username, lflag, adm_sess, dept_code, pnum, email, answer1, answer2 ";
				...
				if(mysql_num_rows($result_set) == 1){
					...
					$_SESSION['lec_name'] = $found_user['lec_name'];
					$_SESSION['lec_sex'] = $found_user['lec_sex'];
					$_SESSION['username'] = $found_user['username'];
					$_SESSION['lflag'] = $found_user['lflag'];
					...
					redirect_to("lecturers.php?regno=$regno");
					...
					<article class="col-md-5">
						<div class="panel panel-default">
				        <div class="panel-heading">
				           <h4>Lecturers Login</h4>
				        </div>
				        <div class="panel-body">
				           <?php if(!empty($message)) {echo "<p class=\"message\">" . $message . "</p>";} ?>
						  <?php if(!empty($errors)) {display_errors($errors);} ?>
				          <form action="login_lecturers2.php" method="post">
				        	   <table>
				          		 <tr>
				                    <td>Username: </td>
