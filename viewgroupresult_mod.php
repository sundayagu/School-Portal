...
<article class="col-lg-12">
    ...
    if(isset($_POST['submit'])){
        ...
        $table_course = $dept . "c";
        $course = get_department_course_for_enterca_exam_by_coursecode_for_modulator($table_course, $ccode, $_SESSION['username'], $session);
        ...
        <table cellspacing="2" style="width:100%;">
            ...
            <tr><td style="text-align:center"><b>Session:</b>&nbsp;&nbsp;<?php echo trim($sessdisplay['session_title']) ?></td>
                <td style="text-align:center"><b>Moderator:</b>&nbsp;&nbsp;<?php echo $course[$moderator] ?></td>
                <td>
                </td>
            </tr>
        ...
        <?php           
            ...
            echo "<a href=\"viewgroupresult_mod.php\">Try Again</a>";
        } // ends empty(errors)
    ...
    ?>    
	    <form action="viewgroupresult_mod.php" method="post">
